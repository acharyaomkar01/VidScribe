...
=======
		<div class="logo"><img src="/static/images/logo_4.png" alt="logo"></a>	
		<form action="/hello" method="POST" enctype="multipart/form-data">
			<center>
				<input class= "myButton" type="file" name="uploaded_file" value="Upload"/>

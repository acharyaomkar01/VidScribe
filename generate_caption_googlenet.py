...
model_place='/home/foo/Downloads/chainer_caption_generation-master/models/caption_model.chainer'
caffe_model_place='/home/foo/Downloads/chainer_caption_generation-master/data/bvlc_googlenet_caffe_chainer.pkl'
index2word_file = '/home/foo/Downloads/chainer_caption_generation-master/work/index2token.pkl'
doc = ''
...
def caption_generate(image_file_name,doc):
    sent = ''
    ...
    for predicted_word in genrated_sentence:
        ...
        if index2word[index] !='<SOS>' and index2word[index] != '<EOS>':
            sent = sent + index2word[index] + ' '
...
for f in sorted(listdir('/var/www/html/static/images/data4/')):
    doc = caption_generate('/var/www/html/static/images/data4/'+f,doc)
